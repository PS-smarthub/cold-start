      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12">
        {/* {Array.from({ length: 12 }, (_, i) => (
          <div
            ...
            key={i}
            className="bg-gray-100 border-l-[10px] transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-105 cursor-pointer border-blue-600 rounded shadow-md p-4 flex flex-col justify-center items-center relative h-48"
          >
